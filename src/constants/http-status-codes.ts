// This file defines standard HTTP status codes
// Like having a list of standard responses for customers
...
export const HTTP_STATUS = {
    // Success responses (like "Yes, we can help!")
    OK: 200,
    CREATED: 201,
    
    // Client error responses (like "Sorry, we don't understand")
    BAD_REQUEST: 400,
    UNAUTHORIZED: 401,
    NOT_FOUND: 404,
    
    // Server error responses (like "Oops, we made a mistake")
